...
public class Controller {
    ...
    private Controller() {
        ...
        Flower f1 = new Flower("Eternal Flame", FlowerType.ROSE, "red", 2021);
        Flower f2 = new Flower("Golden Sunrise", FlowerType.TULIP, "yellow", 2019);
        Flower f3 = new Flower("Snow Queen", FlowerType.ORCHID, "white", 2023);
        Flower f4 = new Flower("Midnight Velvet", FlowerType.ROSE, "black", 2020);
